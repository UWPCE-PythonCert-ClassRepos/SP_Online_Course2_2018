...
from queries_redis import *  # noqa F403
...
class Mailroom:
    ...
    def sort_donors():
        qr = QueriesRedis()  # noqa F403
        donors = qr.get_donor_multiple_summary()
...
class MailroomPrompts:
    ...
    def prompt_index(self):
        ...
        documents = mc.list_donors()  # Use main DB here
        ...
        while True:
            ...
            try:
                ...
                d = qm.get_donor_by_id(documents[index - 1]['_id'])
    ...
    def prompt_donor_insert(self):
        while True:
            ...
            donor = qm.get_donor_by_last(last_name)
    ...
    def prompt_summary(self):
        ...
        qr = QueriesRedis()  # noqa F403
        d = self.prompt_index()
        dl = qr.get_donor_single_summary(d)
    ...
    def prompt_thank_donor(self):
        ...
        donations = qr.donations_total(d)
