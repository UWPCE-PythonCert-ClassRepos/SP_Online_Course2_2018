...
class MailroomPrompts:
    ...
    def prompt_index(self):
        ...
        while True:
            ...
            try:
                ...
                d = q.get_donor_by_id(documents[index - 1]['_id'])
    ...
    def prompt_summary(self):
        ...
        q = QueriesMongo()  # noqa F403
        d = self.prompt_index()
        dl = q.get_donor_single_summary(d)
