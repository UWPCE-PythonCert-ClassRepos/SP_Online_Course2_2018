...
class Controller():
    ...
    def tick(self):
        ...
        curr_action_state = self.pump.get_state()
        next_action = self.decider.decide(
            liquid_height, curr_action_state, self.actions)

        return self.pump.set_state(next_action)
