...
def run_example():
    ...
    try:
        ...
        r.hmset('Bert', {'telephone': '206-123-4567', 'zip': 97755})
        r.hmset('Wilma', {'telephone': '541-828-5555', 'zip': 32256})
        r.hmset('Norbert', {'telephone': '405-867-4993', 'zip': 74483})

        log.info('Step 3: retrieve Bert\'s phone number')
        bert_phone = r.hmget('Bert', 'telephone')
        print(bert_phone)

        log.info('Step 4: retrieve Wilma\'s zip code')
        wilma_zip = r.hmget('Wilma', 'zip')
        print(wilma_zip)
