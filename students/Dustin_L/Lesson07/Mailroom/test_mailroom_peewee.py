#!/usr/bin/env python3
"""This is a test module that tests mailroom_peewee.py"""
...
import mailroom_peewee as mr
from mailroom_peewee import PROMPT_OPTS
...
class TestDonorDict(unittest.TestCase):
    """Unit tests for the DonorDict class"""
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
    ...
    def setUp(self):
        self.db = DonorDict(*[Donor(self.d1_name, self.d1_dons),
