...
def run_example():
    ...
    try:
        ...
        r.hmset("jeremey", {'email': 'jeremy.clarkson@gt.com', 'zip': '98001', 'phone': '123-456-7890'})
        r.hmset('richard', {'email': 'richard.hammond@gt.com', 'zip': '98001', 'phone': '123-456-7890'})
        r.hmset('may', {'email': 'james.may@gt.com', 'zip': '98001', 'phone': '123-456-7890'})
        r.hmset('tom', {'email': 'tom.tomson@gt.com', 'zip': '98001', 'phone': '123-456-7890'})
        r.hmset('bob', {'email': 'bob.boberson@gt.com', 'zip': '98001', 'phone': '123-456-7890'})

        print(r.hget('jeremey', 'zip'))
        print(r.hget('jeremey', 'phone'))
        print(r.hget('richard', 'zip'))
        print(r.hget('richard', 'phone'))
