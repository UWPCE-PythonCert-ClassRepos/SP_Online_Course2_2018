# Description: Mailroom Program - Redis mod
# Author: Andy Kwok
...
#           and mailroom_pt9.py
# v2.0 - Adapted code for Redis, removed json

#!/usr/bin/env python3

# (Supressed) import json_save_meta as json
...
class Mailroom():
    ...
    def save(self):
        ...
        # save_key = self.
        # save_field = {'donation' : []}
        # redis_save(save_item)
        print('Mailroom database saved in Redis....')
    ...
    def load(self):
        try:
            ...
            # self.donorlist = r.keys()
            # for each_donor in self.donorlist:
                # each_data = r.hgetall('each_donor')
                # each_amount = each_data['donation']
                # self.add_donor(each_donor, each_amount) 
...
class Donor():
    ...
    def __init__(self, name=None, donation=[]):
        self.name = name
