...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb+srv://{user}:{pw}@toniluw220-thwo7.mongodb.net/test?retryWrites=true')
...
def login_redis_cloud():
    ...
    try:
        r = redis.StrictRedis(host=host, charset="utf-8", port=port,
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-nbdkkooamoilgbkeeikconcl.dbs.graphenedb.com:24786'
