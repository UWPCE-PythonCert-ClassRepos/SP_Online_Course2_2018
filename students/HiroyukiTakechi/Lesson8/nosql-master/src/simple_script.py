...
def run_example(furniture_items):
    ...
    def run_csv_hiro():
        """
        write and read a csv. Lesson 10 Assignment 1.
        """
        log.info("\n\n====")
        peopledata = [
            ('Customer1', 'Apple', 2, 1.5, 3.0),
            ('Customer2', 'Banana', 3, 2.0, 6.0),
            ('Customer3', 'Cherry', 1, 1.0, 1.0),
            ('Customer4', 'Pear', 2, 3.0, 8.0),
            ('Customer5', 'Orange', 1, 10.0, 10.0),
            ('Customer6', 'Blueberry', 3, 5.0, 15.0),
            ('Customer7', 'Strawberry', 1, 1.0, 1.0),
            ('Customer8', 'Cranberry', 2, 4.0, 8.0),
            ('Customer9', 'Nuts', 1, 2.0, 2.0),
