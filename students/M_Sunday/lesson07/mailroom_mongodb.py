...
class DonorData(object):
    ...
    def __init__(self):
        self.client = self.mongodb_login()
        db = self.client['dev']
        donors = db['donors']
        self.donor_data_ = donors.find()

    def mongodb_login(self):
        config_file = "C:\\Users\\mmsunday\\Desktop\\School\\UW - Python Programming\\" \
                      "SP_Online_Course2_2018\\students\\M_Sunday\\lesson07\\config.ini"
        ...
        client = pymongo.MongoClient(
            f'mongodb://{user}:{pw}@cluster0-shard-00-00-maquj.mongodb.net:'
            f'27017,cluster0-shard-00-01-maquj.mongodb.net:27017,cluster0-'
            f'shard-00-02-maquj.mongodb.net:27017/test?ssl=true&replicaSet='
            f'Cluster0-shard-0&authSource=admin&retryWrites=true')
