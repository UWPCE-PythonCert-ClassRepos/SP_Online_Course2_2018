...
class Donors_All:
    ...
    def save(self, file_name='donors.json'):
        """ Save donors in a json file """
        with open(file_name, 'w') as f:
            self.to_json(f)
        print("Saved donor list to file: {:s}!\n".format(file_name))

    def load(self, file_name='donors.json'):
        ...
        try:
            ...
            print("Loaded donor list from file: {:s}\n".format(file_name))
