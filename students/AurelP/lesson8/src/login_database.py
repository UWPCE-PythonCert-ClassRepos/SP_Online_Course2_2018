...
def login_redis_cloud():
    ...
    try:
        ...
        # host = 'redis-18466.c9.us-east-1-2.ec2.cloud.redislabs.com'
        # port = 18466
        # pw =  'uGBuVBjFIhTBQri9wzQlwwTom0TaNmH3'
...
def login_neo4j_cloud():
    ...
    # graphenedb_user = 'aurelp2'
    # graphenedb_pass = 'b.PueuR03bcMWp.pzrtVGWeTvIjCrYK'
    # graphenedb_url = 'bolt://hobby-mkjicgoikcfjgbkejkcdomcl.dbs.graphenedb.com:24786'
