...
class Decider():
    ...
    def __init__(self, target_height, margin):
        """
        Create a calculator decider instance for this tank.
        ...
        :param margin: the margin of liquid above and below the target height
                       ...
                       represents a 5% margin above and below the target
                       height.
        """
    ...
    def decide(self, current_height, current_action, actions):
        """
        Decide a calculator action for the pump, given the current height of
        liquid in the tank and the current action of the pump.

        Note that the calculator action for the pump MAY be the same as the
        ...
        :param actions: a dictionary containing the keys 'PUMP_IN', 'PUMP_OFF',
                        and 'PUMP_OUT'
        :return: The calculator action for the pump:
