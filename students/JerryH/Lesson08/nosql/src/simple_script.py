...
def run_example(furniture_items):
    ...
    def run_csv():
        ...
        log.info("\n\n====")
        peopledata = [
            ('John', 'second guitar', 'red', 98765, 117.45),
            ('Paul', 'bass', 'blue', 76543, 22.01),
            ('George', 'lead guitar', 'pink', 43256, 45.99),
            ('Ringo', 'drume', 'brown', 34211, 77.0),
            ('Roger', 'vocals', 'violet', 89765, 12.5),
            ('Keith', 'drums', 'grey', 23441, 6.25),
            ('Pete', 'guitar', 'brown', 87665, 0.1),
            ('John', 'bass', 'purple', 78909, 89.71),
            ('Jerry', 'piano', 'yello', 76353, 56.71),
            ('Barry', 'phone', 'orange', 87664, 89.71)
        ]
