...
def run_example():
    ...
    try:
        ...
        log.info('Step 2: add customer data to cache')
        r.hmset('John', {'telephone': '206-123-4567', 'zip': 98253})
        r.hmset('William', {'telephone': '541-828-5555', 'zip': 25362})
        r.hmset('Norbert', {'telephone': '405-867-4993', 'zip': 78541})

        log.info('Step 3: retrieve John\'s phone number')
        john_phone = r.hmget('John', 'telephone')
        print(john_phone)

        log.info('Step 4: retrieve William\'s zip code')
        william_zip = r.hmget('William', 'zip')
        print(william_zip)
