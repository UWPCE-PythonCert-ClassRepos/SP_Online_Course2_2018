...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb://{user}:{pw}@pyclass-shard-00-00-4oeku.mongodb.net:27017,pyclass-shard-00-01-4oeku.mongodb.net:27017,pyclass-shard-00-02-4oeku.mongodb.net:27017/test?ssl=true&replicaSet=PyClass-shard-0&authSource=admin&retryWrites=true')
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-nmbjkfpihbpggbkeohmfknbl.dbs.graphenedb.com:24786'
