...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb://{user}:{pw}'
                                 '@cluster0-shard-00-00-kisus.mongodb.net:27017,'
                                 'cluster0-shard-00-01-kisus.mongodb.net:27017,'
                                 'cluster0-shard-00-02-kisus.mongodb.net:27017/test'
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-efmhckdgahdggbkeoanpkdbl.dbs.graphenedb.com:24786'
