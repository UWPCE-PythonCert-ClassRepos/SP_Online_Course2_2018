...
class Controller(object):
    ...
    def tick(self):
        ...
        liquid_level = self.sensor.measure()
        curr_pump_state = self.pump.get_state()
        new_pump_state = self.decider.decide(liquid_level,
                                             curr_pump_state,
                                             self.actions)

        return self.pump.set_state(new_pump_state)
