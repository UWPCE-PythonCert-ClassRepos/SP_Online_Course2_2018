...
class Department(BaseModel):
    """
        This class defines the department, which has the following data:
        we need to know it's department number, which is 4 characters long and start with a letter
...
class Job(BaseModel):
    ...
    dept_num = ForeignKeyField(Department, related_name='job_in_dept', null = False)
...
database.create_tables([Job, Person, PersonNumKey, Department])
