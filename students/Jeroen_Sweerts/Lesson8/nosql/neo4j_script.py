...
#############################################################################################################
        ...
        log.info("Assign favorite colors to people.")
        for first, last in [('Bob', 'Jones'),
                            ('Nancy', 'Cooper'),
                            ('Alice', 'Cooper')]:
            for color in ['Pink',
        ...
        for first, last in [('Pal', 'Jas'),
                            ('Mad','Onna'),
                            ('Hillarious','Clinton')]:
            for color in ['AppleBlueSeaGreen',
                          'Rainbow'
                         ]:
        ...
        log.info("Show people's favorite colors")
