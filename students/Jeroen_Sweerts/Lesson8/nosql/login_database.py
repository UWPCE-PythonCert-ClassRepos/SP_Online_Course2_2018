...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb+srv://{user}:{pw}@cluster0-4htnn.mongodb.net/test?retryWrites=true&w=majority')
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-iblfbklmcpbbgbkekbpbfecl.dbs.graphenedb.com:24787'
