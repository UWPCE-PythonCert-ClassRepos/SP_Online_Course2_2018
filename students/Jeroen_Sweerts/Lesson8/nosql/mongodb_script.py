...
def run_example(furniture_items):
    ...
    with login_database.login_mongodb_cloud() as client:
        ...
        log.info('Step 8: Assignment')
        red_query = {'product_color': 'Red'}
        ...
        couch_results = furniture.find(couch_query)
        print('Couches')
        for item in couch_results:
            pprint.pprint(item)
...
def mongo_assignment_create(furniture_items):
