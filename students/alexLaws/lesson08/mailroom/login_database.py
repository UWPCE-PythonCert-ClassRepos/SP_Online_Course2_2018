...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb+srv://lawsalex:{pw}@cluster0-adtn0.mongodb.net/test?retryWrites=true')
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-gmjjagjhhihbgbkepbjpkpbl.dbs.graphenedb.com:24786'
