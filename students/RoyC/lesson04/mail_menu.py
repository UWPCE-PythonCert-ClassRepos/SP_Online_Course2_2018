...
def save_donors():
    ...
    """
    filename = input("\nEnter name of file to save, or 'q' to cancel: ")
    if (filename == "q"):
        return
    donation_records.save(filename)
    
def load_donors():
    """
    Load donor data from file
    """
    filename = input("\nEnter name of file to load, or 'q' to cancel: ")
    if (filename == "q"):
        return
    donation_records.load(filename)
...
main_prompt = ("\nPlease choose one of these options:"
               ...
               "\n   4 - Clear donor data"
               "\n   5 - Save donor data to file"
               "\n   6 - Load donor data from file"
               "\n   q - Quit"
