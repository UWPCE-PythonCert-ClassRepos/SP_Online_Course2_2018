...
def run_example(furniture_items):
    """
    Choosing Pickle for Lesson 8 Part 1.
    ...
    def pickle_lesson8():
        """
        Write and read with pickle for Lesson 8 Part 1
        """
        log.info("\n\n====")
        log.info('Lesson 8 Part 1')
        log.info('Write a pickle file with data')
        data = {1: ('a', 'b', 'c', 'd', 'e'),
                2:('a', 'b', 'c', 'd', 'e'),
                3: ('a', 'b', 'c', 'd', 'e'),
                4: ('a', 'b', 'c', 'd', 'e'),
        ...
        pickle.dump(data, open('../data/data_new.pkl', 'wb'))
        log.info('Step 2: Now read it back from the pickle file')
        read_data = pickle.load(open('../data/data_new.pkl', 'rb'))
        log.info('Step 3: Show that the write and read were successful')
