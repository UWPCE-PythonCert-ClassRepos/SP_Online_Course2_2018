...
def run_example(flying_pokemon):
    """
    ...
    def run_pickle():
        ...
        log.info('Write a pickle file with the flying_pokemon data')

        pickle.dump(flying_pokemon, open('../data/data.pkl', 'wb'))
        ...
        assert read_data == flying_pokemon
        log.info("and print the data")
        pprint.pprint(flying_pokemon)
