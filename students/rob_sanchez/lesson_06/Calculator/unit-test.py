...
class DividerTests(TestCase):
    ...
    def test_dividing(self):
        ...
        for i in range(1, 10):
            for j in range(10, 1):
                self.assertEqual(j / i, divider.calc(j, i))
        self.assertEqual("Can't divide by zero!", divider.calc(1, 0))
...
class CalculatorTests(TestCase):
    ...
    # Test adder call with operands in the specified order
    ...
    # Test subtracter call with operands in the specified order
    ...
    # Test multiplier call with operands in the specified order
    ...
    # Test divider call with operands in the specified order
    ...
    # Test divider call with operands in the specified order
    def test_invalid_divider_call(self):
        self.divider.calc = MagicMock(return_value=0)
