...
def login_mongodb_cloud():
    ...
    # updated to new connection format to as we are using pymongo 3.7.
    # was having trouble with previous format
    client = pymongo.MongoClient(f"mongodb+srv://{user}:{pw}@mailroom-dom9o.mongodb.net/test?retryWrites=true")
    return client
