...
class Controller(object):
    ...
    def tick(self):
        ...
        current_liquid_height = self.sensor.measure()
        current_pump_state = self.pump.get_state()
        next_pump_state = self.decider.decide(
            current_liquid_height, current_pump_state, self.actions)

        return self.pump.set_state(next_pump_state)
