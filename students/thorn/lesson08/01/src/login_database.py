...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb+srv://{user}:{pw}@cluster0-c6vjx.mongodb.net/test?retryWrites=true')
...
def login_neo4j_cloud():
    ...
    graphenedb_url = 'bolt://hobby-bncfabinbmeogbkejmnkppbl.dbs.graphenedb.com:24786'
