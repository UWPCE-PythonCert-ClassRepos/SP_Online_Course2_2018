...
def run_example(furniture_items):
    ...
    with login_database.login_mongodb_cloud() as client:
        ...
        log.info('Step 5: Print the red products')
        query = {'color': 'red'}
        ...
        log.info('Step 7: Delete the blue couch (actually deletes all blue '
                 'couches)')
        furniture.remove({"product": {"$eq": "Blue couch"}})

        log.info('Step 8: Check it is deleted with a query and print')
