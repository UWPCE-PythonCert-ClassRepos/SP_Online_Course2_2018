...
# Dev:   Craig Morton
# Date:  12/20/2018
# Change Log: CraigM, 12/30/2018, Database Management, Mail Room
# ------------------------------------------------- #

# Mail room user interface
...
def name_deletion():
    ...
    return input('\nPlease enter the full name of the Donor you wish to delete:  ')
...
main_menu = """
                                        ...
                                        A> Add new Donor
                                        B> Delete Donor
                                        C> Generate Donor report
                                        D> Send Donor letters
                                        E> Exit
