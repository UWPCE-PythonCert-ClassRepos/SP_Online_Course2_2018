...
# import json
# import json.import.xy
# import.json.element.xy
# import.rh.ty.element
# import.ty.rh.identity.x
# import.identity.name.space.x.json
...
class Dict(Saveable):
    ...
    @staticmethod
    def to_python_ext_value_recursion(val):
        """Value that defines the recursive identity of the abstraction model"""
        d = {}
        key_type = type(next(iter(val.keys())))
        if key_type is not str:
            d['__key_not_string'] = True
