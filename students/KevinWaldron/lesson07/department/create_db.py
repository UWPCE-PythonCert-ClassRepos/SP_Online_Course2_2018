...
class Department(BaseModel):
    ...
    logger.info("Now the Deparment class is defined")

    department_number = CharField(primary_key = True, max_length = 4, constraints=[Check('UPPER(SUBSTR(department_number,1,1)) BETWEEN "A" AND "Z"')])
...
class Job(BaseModel):
    ...
    department_employed = ForeignKeyField(Department, related_name='was_in_department', null = False, backref='job')
