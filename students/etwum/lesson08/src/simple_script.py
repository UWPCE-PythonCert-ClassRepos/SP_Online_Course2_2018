...
def run_example(player_data):
    ...
    def run_pickle():
        ...
        log.info('Write a pickle file with the player data')

        pickle.dump(player_data, open('../data/player_data.pkl', 'wb'))

        log.info('Step 2: Now read it back from the pickle file')
        read_data = pickle.load(open('../data/player_data.pkl', 'rb'))
