...
log = ut.configure_logger('default', '../logs/login_databases_dev.log')
config_file = Path('C:/Users/Emmanuel/Documents/GitHub/SP_Online_Course2_2018/students/etwum/lesson08/.config/config.ini.sample')
...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f'mongodb://{user}:{pw}'
                                 '@cluster0-shard-00-00-e78ia.mongodb.net:27017,'
                                 'cluster0-shard-00-01-e78ia.mongodb.net:27017,'
                                 'cluster0-shard-00-02-e78ia.mongodb.net:27017/'
