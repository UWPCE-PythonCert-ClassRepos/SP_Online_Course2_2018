...
class Decider():
    ...
    def height_checker(self, cur_height):
        ...
        returns int whether current height is below,
        between, or above target height
        """
    ...
    def decide_pump_action(current_action, actions):
        """
        Closer function that returns an action based
        on the current status of pump and water level.
        """
        ...
        def decide_level(current_height):
            if current_action == -1:
                ...
                # PUMP_OUT and in between or level or above level
            ...
            if current_action == 1:
                ...
                # PUMP_IN and either in between level or below min level
