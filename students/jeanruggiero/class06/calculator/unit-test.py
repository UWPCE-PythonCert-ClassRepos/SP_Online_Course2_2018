...
class CalculatorTests(TestCase):
    ...
    def test_adder_call(self):
        ...
        self.assertEqual(self.calculator.stack,
                         [self.adder.calc.return_value])


    def test_subtracter_call(self):
        self.subtracter.calc = MagicMock()
        ...
        self.assertEqual(self.calculator.stack,
                         [self.subtracter.calc.return_value])


    def test_multiplier_call(self):
        self.multiplier.calc = MagicMock()
        ...
        self.assertEqual(self.calculator.stack,
                         [self.multiplier.calc.return_value])


    def test_divider_call(self):
        self.divider.calc = MagicMock()
        ...
        self.assertEqual(self.calculator.stack,
                         [self.divider.calc.return_value])
