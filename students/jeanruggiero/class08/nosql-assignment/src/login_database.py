...
def login_mongodb_cloud():
    ...
    client = pymongo.MongoClient(f"mongodb://{user}:{pw}@cluster0-shard-00-00-ofcip.mongodb.net:27017,cluster0-shard-00-01-ofcip.mongodb.net:27017,cluster0-shard-00-02-ofcip.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true")
