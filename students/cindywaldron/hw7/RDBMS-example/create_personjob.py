...
class Department(BaseModel):
    """
        This class defines departmet which maintains department number,
        department name, manager and job duration
    """
...
class Job(BaseModel):
    ...
    job_duration = IntegerField(default=0)
    job_department = ForeignKeyField(Department, related_name='Job in department', null = False)
