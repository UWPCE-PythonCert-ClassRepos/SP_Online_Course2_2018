...
collection = Donations({'William Gates, III': Donor('William Gates, III', [100.00, 200.00]),
...
def display_main_menu():
    """Display main menu"""
    print('\nChoose an action:')
    selection_list = ['1. Send Thank You', '2. Create a Report', '3. Send letters to everyone', '4. Projections', '5. Save', '6. Load', '7. Quit']
    option_str = '\n'.join(['\t'+item for item in selection_list])
    print(option_str)

def main():
    choice = ''
    selection = 'Select an option (1, 2, 3, 4, 5, 6, or 7) ===>'
    switch_function_dict = {'1': send_thank_you, '2': create_report, '3': send_letters, '4': projections, '5': save, '6': load, '7': quit}
    while True:
        # Display main menu
        display_main_menu()
