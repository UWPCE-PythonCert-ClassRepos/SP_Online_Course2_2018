...
class Job(BaseModel):
    ...
    duration = DecimalField(max_digits = 6, decimal_places = 1)


class Department(BaseModel):
    """
        This class defines a department, which maintains the details
        of each department in which a person worked.
    """
    department_number = CharField(max_length=4)
