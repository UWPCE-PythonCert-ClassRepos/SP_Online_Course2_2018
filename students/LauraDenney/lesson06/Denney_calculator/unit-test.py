...
class CalculatorTests(TestCase):
    ...
    def test_init(self):
        assert isinstance(self.calculator.adder, Adder)
        assert isinstance(self.calculator.subtracter, Subtracter)
        assert isinstance(self.calculator.multiplier, Multiplier)
        assert isinstance(self.calculator.divider, Divider)
    ...
    def test_enter_number(self):
        ...
        self.assertEqual(num, self.calculator.stack[0])
