# -------------------------------------------------------------------------------------
# PROJECT NAME: great_circle_v2.py
# NAME: Micah Braun
# DATE CREATED: 11/30/2018
# UPDATED:
# PURPOSE: Lesson 10 final
# DESCRIPTION: Function is optimized for the C/static language by:
#              - Removed Python library dependency/replaced with C's "math.h"
#              - Explicit variable assignment for value of pi (with type)
#
# ON RUN: Program took  2.306s to complete processes on 64-bit OS with 16 GB RAM
# -------------------------------------------------------------------------------------
