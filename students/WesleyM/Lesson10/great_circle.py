...
if __name__ == "__main__":
    ...
    t = timeit.Timer("great_circle_v3.great_circle(%f,%f,%f,%f,%f)" % (lon1,lat1,lon2,lat2, num), 
                       "import great_circle_v3")
    print("Cython function (using trig function from math.h) and defining number of runs", t.timeit(num), "sec")
